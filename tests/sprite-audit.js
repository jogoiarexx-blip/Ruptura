...
for(const s of ['playerSpriteSets','enemySpriteSets','drawEnemyFallback',"saveKey='ruptura-save-v028'"]) if(!m.includes(s)) throw Error('missing '+s);
console.log('PASS sprite-audit v0.2.8');
