...
for(const s of ['playerSpriteSets','enemySpriteSets','drawEnemyFallback',"saveKey='ruptura-save-v037'"]) if(!m.includes(s)) throw Error('missing '+s);
console.log('PASS sprite-audit v0.3.7');
