...
if(!main.includes("saveKey='ruptura-save-v040'")) throw Error('save');
...
for(const s of ['APP_CACHE','PRECACHE_URLS','cacheAllIndividually','ruptura-full-offline-v040','fetch']) if(!sw.includes(s)) throw Error('missing '+s);
...
console.log('PASS pwa-audit v0.4.0');
