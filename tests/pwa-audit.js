...
if(!main.includes("saveKey='ruptura-save-v037'")) throw Error('save');
...
for(const s of ['APP_CACHE','PRECACHE_URLS','cacheAllIndividually','ruptura-full-offline-v037','fetch']) if(!sw.includes(s)) throw Error('missing '+s);
...
console.log('PASS pwa-audit v0.3.7');
